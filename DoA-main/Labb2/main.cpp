...
//cd "c:\Users\Manjaro\Desktop\DoA-main\DoA-main\Labb2\" ; if ($?) { g++ main.cpp dataGenerator.cpp selectionSort.cpp insertionSort.cpp quickSort.cpp handleMeasurements.cpp -o main } ; if ($?) { .\main }
